...
// >
//   Explore the distinctive wines of Germany.
//   Discover Laurentia&apos;s curated collection, where celebrated German
//   terroirs, expressive grape varieties, and centuries of winemaking tradition
...
//      Germany Wine Collection
// </h2>

// <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-white">
//   Discover Laurentia&apos;s collection of exceptional German wines,
//   showcasing renowned wine regions, expressive grape varieties, and the
//   timeless character of Germany&apos;s distinguished winemaking heritage.
// </p>
//   </div>
...
//   We couldn&apos;t find any German wine or region matching{" "}

//   <span className="font-semibold text-[#65002d]">
//     &quot;{searchTerm}&quot;
//   </span>

//   Try searching for wines like Riesling, Spätburgunder, Grauburgunder,
//   Weißburgunder, Silvaner, or Dornfelder.
// </p>
...
//   Laurentia • Germany Wine Collection
// </p>
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            Elegant wines from Germany
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection of German wines, featuring the expressive
            character and refined sweetness of Riesling from the country&apos;s
      ...
      <section className="px-6 pb-24 sm:px-10 lg:px-16 lg:pb-32">
        {/* <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-[#6D625B]">
            A curated selection from distinguished German vineyards and
            producers.
          </p>
        </div> */}
        ...
        <div className="mt-14 border-t border-[#741C29]/10 pt-8 text-center">
          ...
          <p className="mt-2 font-old-standard text-sm text-[#6D625B]">
            {wineCount} {wineCount === 1 ? "wine" : "wines"} from{" "}
            {producers.length}{" "}
