...
const regions = [
  ...
  { name: "Loire", slug: "loire" },
  { name: "Bordeaux", slug: "bordeaux" },
  { name: "Burgundy", slug: "burgundy" },
  { name: "Rhône", slug: "rhone" },
  { name: "Provence", slug: "provence" },
];

export default function FranceRegionsPage() {
  return (
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Explore the distinctive wine regions of France, from the
            celebrated vineyards of Champagne and Bordeaux to the elegant
            terroirs of Burgundy, Rhône, Loire, and Provence.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {regions.map((region, index) => (
              <Link
                key={region.slug}
                href={`/regions/france/${region.slug}`}
                className="
                  group
                  relative
                  min-h-[225px]
          ...
          >
            <p className="font-old-standard text-sm text-[#6D625B]">
              Personally selected from across France
            </p>
