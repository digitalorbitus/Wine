...
//     image: "/Pinot Noir Zenith Vineyard.png",
//     description:
...
//     country: "Oregon",
//     style: "Redhawk Winery",
//     image: "/Pinot Noir Willamette Valley.png",
//     description:
...
//             >
//            Explore the distinctive wines of Ohio. Discover Laurentia's collection of
// carefully crafted wines, from bold Cabernet Sauvignon and elegant Pinot Noir
// to expressive Riesling and Vidal Blanc Ice Wine.
//             </motion.p>
//           </div>
...
//   style={{
//   backgroundImage:
//   "url('https://ohiomagazine.imgix.net/sitefinity/images/default-source/sponsored-content-photos/sip-2022/rsz_wine_road_trips_laurentia_winery_laura_watilo_blake.jpg?auto=compress%2Cformat&sfvrsn=c8b8bf38_3&w=960')",
...
//        Ohio Wine Collection
//     </h2>

//  <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-white">
//   Discover Laurentia wines from Ohio, featuring classic red varieties,
//   refreshing whites, sparkling rosé, and distinctive Ice Wine.
// </p>
//   </div>
...
export default function LaurentiaPage() {
  return (
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover Laurentia wines from Ohio, where carefully tended
            vineyards express the character of the region through elegant
            whites, expressive reds and distinctive sparkling wines.
          </p>
      ...
      <section className="px-6 pb-24 sm:px-10 lg:px-16 lg:pb-32">
        {/* <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-[#6D625B]">
            A curated selection from Laurentia, showcasing the distinctive
            character of Ohio wine country.
          </p>
        </div> */}
