...
// >
//   Explore the distinctive wines of Portugal.
//   Discover Laurentia&apos;s curated collection, where historic Portuguese
//   wine regions, indigenous grape varieties, and centuries of winemaking
//   tradition come together in every bottle.
// </motion.p>
//           </div>
...
//   style={{
//   backgroundImage:
//   "url('https://images.unsplash.com/photo-1555881400-74d7acaacd8b?auto=format&fit=crop&w=1200&q=85')",
...
//   Discover Laurentia&apos;s collection of exceptional Portuguese wines,
//   showcasing renowned regions, distinctive indigenous grape varieties,
//   and the rich heritage of Portugal&apos;s celebrated winemaking tradition.
// </p>
//   </div>
...
//   We couldn&apos;t find any Portuguese wine or region matching{" "}

//   <span className="font-semibold text-[#65002d]">
//     &quot;{searchTerm}&quot;
//   </span>

//   Try searching for wines like Touriga Nacional, Touriga Franca,
//   Tinta Roriz, Alvarinho, Arinto, or Baga.
// </p>
...
//  Laurentia • Portugal Wine Collection
// </p>
...
const producers = [
...

  {
    ...
    subtitle: "Douro & Vinho Verde",
    wines: [
      {
        name: "Dona Cepa, DOC Douro",
        year: "2020",
        alcohol: "13%",
        detail: "Touriga Nacional · Touriga Franca · Tinta Roriz",
      },
      {
        name: "Alvarinho, DOC",
        year: "2023",
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            From Atlantic vineyards to timeless fortified wines
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection of Portuguese wines, from the distinctive
            Madeira wines of Justino to the celebrated Ports and fresh Vinho
            Verde and Douro wines of Quinta das Arcas.
          </p>
        ...
        {/* Stats */}
        <div className="mx-auto mt-10 grid max-w-5xl grid-cols-2 overflow-hidden rounded-2xl border border-[#741C29]/10 bg-[#741C29]/10 sm:grid-cols-3">
      ...
      <section className="px-6 pb-24 sm:px-10 lg:px-16 lg:pb-32">
        {/* <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-[#6D625B]">
            A curated selection from distinguished Portuguese producers,
            featuring Madeira, Port, Douro and Vinho Verde wines.
          </p>
        </div> */}
