...
const producers = [
  {
    name: "Redhawk Winery, Willamette Valley",
    wines: [
      {
        name: "Pinot Noir, Zenith Vineyard, EOLA-Amity Hills",
        year: "2021",
        alcohol: "13.5%",
        detail: "",
      },
      {
        name: "Pinot Noir, Estate, EOLA-Amity Hills",
        year: "2021",
        alcohol: "13.6%",
        detail: "Only 300 cases",
      },
      {
      ...
      },
      {
        ...
        year: "2019",
        alcohol: "14%",
        detail: "51% Merlot, 39% Cabernet Sauv",
      },
    ],
  },
];
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            Elegance from the Willamette Valley
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection from Redhawk Winery in the Willamette
            Valley, featuring expressive Pinot Noir from EOLA-Amity Hills and
            distinctive red blends from Oregon&apos;s renowned wine country.
          </p>
      ...
      <section className="px-6 pb-24 sm:px-10 lg:px-16 lg:pb-32">
        {/* <div className="mb-12 text-center">
          ...
          <h2 className="mt-1 font-philosopher text-3xl text-[#741C29] sm:text-4xl lg:text-5xl">
            Wines from Redhawk Winery
          </h2>

          <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-[#6D625B]">
            A curated selection from distinguished Willamette Valley vineyards.
          </p>
        </div> */}
