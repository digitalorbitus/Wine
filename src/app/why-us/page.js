      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-[#e77e4e]/10 rounded-3xl -z-10 blur-xl pointer-events-none" />
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {whyUsData.map((item) => (
                <div
                  key={item.id}
                  className="group relative bg-white p-6 rounded-2xl border border-zinc-200/80 shadow-sm hover:shadow-xl hover:border-[#e77e4e]/40 transition-all duration-300 flex flex-col justify-between"
                >
                  <div>
                    {/* Icon Container */}
                    <div className="w-12 h-12 rounded-xl bg-[#e77e4e]/10 text-[#e77e4e] flex items-center justify-center transition-all duration-300 group-hover:bg-[#e77e4e] group-hover:text-white group-hover:scale-110 shadow-sm">
                      {item.icon}
                    </div>
                  ...
                  <div className="mt-6 w-8 h-[2px] bg-zinc-200 group-hover:w-full group-hover:bg-[#e77e4e] transition-all duration-300" />
                </div>
              ))}
            </div>
          </div>
