...
const producers = [
  {
    name: "Bodega As Laxas",
    subtitle: "Rías Baixas",
    wines: [
      {
        name: "Laxas Albariño",
        year: "2023",
      ...
      },
      {
        ...
        year: "N/V",
        alcohol: "12.5%",
        detail: "Traditional Method Brut",
      },
    ],
  },

  {
    name: "Bodega la Milagrosa",
    subtitle: "Ribera del Duero",
    wines: [
      {
        name: "Milcampos, Ribera del Duero",
        year: "2018",
        alcohol: "13.5%",
        detail: "Tempranillo",
      },
  ...
  {
    name: "Bodegas Delgado Zuleta",
    subtitle: "Jerez, Xeres, Sherry",
    wines: [
      {
        name: "Pedro Ximénez Sherry",
        year: "N/V",
    ...
    wines: [
      {
        ...
        year: "2020",
        alcohol: "14.1%",
        detail: "100% Tempranillo · 4–5 months American oak",
      },
      {
        name: "Titos",
        year: "2018",
        alcohol: "14.1%",
        detail: "100% Garnacha · 11 months in oak",
      },
    ],
  },

  {
    ...
    wines: [
      ...
      },
      {
        ...
        year: "2023",
        alcohol: "13%",
        detail: "100% Tempranillo",
      },
    ],
  },

  {
    name: "Bodegas Pedro Luis Martinez",
    subtitle: "Jumilla",
    wines: [
      {
        name: "Hilanda",
    ...
    wines: [
      {
        ...
        year: "2014",
        alcohol: "14%",
        detail: "Garnacha Tintorera",
      },
      {
        name: "El Bon Homme",
        year: "2016",
        alcohol: "13.5%",
        detail: "50% Cabernet Sauvignon · 50% Monastrell",
      },
    ],
  },

  {
    name: "Bodegas Viñedos de Nieva",
    subtitle: "Rueda",
    wines: [
      {
        name: "Blanco Nieva",
  ...
  {
    name: "Celler Malondro",
    subtitle: "Montsant",
    wines: [
      {
        name: "Besllum - Montsant",
        year: "2011",
        alcohol: "14%",
        detail: "45% Cariñena · 45% Garnacha · 10% Syrah",
      },
    ],
  },

  {
    name: "Pepe Rodriguez de Vera",
    subtitle: "Almansa & Jumilla",
    wines: [
      {
        name: "Jumenta (Almansa)",
        year: "2022",
        alcohol: "14%",
        detail:
          "60% Syrah · 20% Merlot · 20% Garnacha Tintorera · 6 months used French oak",
      },
      {
        name: "Pituco (Jumilla)",
        year: "2022",
        alcohol: "14%",
        detail:
          "70% Monastrell · 15% Garnacha Tintorera · 15% Syrah · 5 months French oak",
      },
    ],
  },
];
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            A tapestry of Spanish wine
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection of Spanish wines, from the Atlantic
            vineyards of Rías Baixas and the celebrated reds of Ribera del
            Duero to the historic Sherry traditions of Jerez and the warm
            Mediterranean vineyards of Jumilla, Valencia and Montsant.
          </p>
      ...
      <section className="px-6 pb-24 sm:px-10 lg:px-16 lg:pb-32">
        {/* <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-[#6D625B]">
            A curated selection from distinguished Spanish producers and
            vineyards across some of the country&apos;s most renowned wine
            regions.
          </p>
        </div> */}
