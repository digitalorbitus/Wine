...
const producers = [
  {
    name: "Tenuta Le Lune del Vesuvio",
    wines: [
      {
        ...
        alcohol: "13.5%",
        year: "2023",
        detail: "Piedirosso and Aglianico · 6 months in barriques",
      },
      {
        ...
        alcohol: "13.5%",
        year: "2024",
        detail: "Piedirosso and Aglianico",
      },
      {
        ...
        alcohol: "13.5%",
        year: "2024",
        detail: "Coda di Volpe and Falanghina",
      },
      {
      ...
      },
      {
        ...
        alcohol: "14.5%",
        year: "2019",
        detail: "100% Aglianico · 24 months in barrels",
      },
      {
        name: "Luna Rosso",
        appellation: "IGP",
      ...
      },
      {
        ...
        year: "2023",
        detail:
          "60% Piedirosso, 40% Merlot · 2 months in French barriques",
      },
      {
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
              Land of ancient vines and volcanic soils
            </p>

            <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
              Discover our selection of wines from Campania, featuring the
              volcanic character of Vesuvio, the noble Aglianico of Taurasi,
              and distinctive regional white wines from renowned producers.
            </p>
