    ...
    wines: [
      {
        ...
        alcohol: "13.5%",
        year: "2017",
        detail: "100% Primitivo · Tre Bicchieri",
      },
      {
    ...
    wines: [
      {
        ...
        year: "2021",
        detail:
          "50% Primitivo, 50% Aglianico · Part of the wine is appassimento · 9 months in French and American barrels",
      },
      {
        ...
        year: "2012",
        detail:
          "Negroamaro and Malvasia Nera · Part of the wine is appassimento · 12 months in French barriques",
      },
      {
        ...
        year: "2020",
        detail:
          "Negroamaro and Malvasia Nera · 9 months in barriques · Tre Bicchieri",
      },
      {
        ...
        alcohol: "15%",
        year: "2019",
        detail: "100% Primitivo di Manduria · 9 months in barriques",
      },
      {
        ...
        year: "2022",
        detail:
          "100% Primitivo di Manduria · Aged in 2nd and 3rd passage French and American barriques",
      },
      {
        ...
        year: "2022",
        detail:
          "100% Susumaniello · Short aging in 2nd and 3rd passage French barriques",
      },
      {
        ...
        alcohol: "12.5%",
        year: "2023",
        detail: "100% Chardonnay · Short aging in wood",
      },
    ],
  },
  {
    ...
    wines: [
      {
        ...
        year: "2022",
        detail:
          "100% Primitivo di Manduria · 6-12 months in French barriques",
      },
      {
        ...
        year: "2022",
        detail:
          "100% Primitivo di Manduria · 8-12 months in French oak",
      },
      {
        name: "Tiranno",
        appellation: "IGP",
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            Sun-drenched vineyards of the South
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection of wines from Puglia, featuring expressive
            Primitivo, Negroamaro, Susumaniello and distinctive white wines
            from some of the region&apos;s renowned producers.
          </p>
