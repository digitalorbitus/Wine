...
const producers = [
  {
    name: "Château Le Grand Verdus",
    wines: [
      {
        name: "Grande Réserve Bordeaux",
        alcohol: "14%",
        year: "2018",
        detail: "55% Merlot, 27% Cabernet Franc, 18% Cabernet Sauvignon",
      },
      {
        name: '"Generation" Bordeaux Supérieur',
        alcohol: "13.5%",
        year: "2018",
        detail: "45% Merlot, 55% Cabernet Franc · 13 months in barrique",
      },
      {
        ...
        year: "2020",
        detail:
          "60% Merlot, 40% Cabernet Sauvignon · 50% in oak, 50% cement tanks for 12 months",
      },
      {
        name: "Bordeaux Supérieur Rouge",
        alcohol: "14%",
        year: "2020",
        detail: "70% Merlot, 30% Cabernet Sauvignon",
      },
      {
        name: "Bordeaux Blanc",
        alcohol: "12.5%",
        year: "2023",
        detail: "60% Sauvignon Blanc, 40% Sémillon",
      },
      {
        name: "Bordeaux Rosé",
        alcohol: "12.5%",
        year: "2020",
        detail: "50% Cabernet Franc, 20% Merlot",
      },
    ],
  },
];
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="font-great-vibes text-3xl text-[#B89B6A] sm:text-4xl">
            The soul of classic Bordeaux
          </p>

          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover our selection of wines from Bordeaux, featuring elegant
            Merlot, Cabernet Franc, Cabernet Sauvignon and refined white and
            rosé wines from distinguished Bordeaux vineyards.
          </p>
