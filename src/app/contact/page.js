...
// ==================== TYPE 4 DATA ====================
  ...
  const type5Data = [
    ...
    },
    {
      ...
      normalBg: 'bg-[#3498db]',            // Blue Hexagon
      hoverBoxBg: 'hover:bg-[#3498db]', // Hover Full Box Blue
    ...
    },
    {
      ...
      normalBg: 'bg-[#f05a88]',            // Pink Hexagon
    ...
    },
    {
      id: 4,
      title: 'GIVE US IDEAS',
      normalBg: 'bg-[#5fb059] ',            // Green Hexagon
    ...
    <section className="w-full bg-white py-14 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-1">
          <h1 className="text-2xl sm:text-3xl font-serif text-zinc-900 tracking-wider uppercase font-medium">
            CONTACT INFO
          </h1>
...
></iframe>
          ...
          <div className="flex flex-col space-y-5">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl italic text-[#9c3545] font-serif">
                Type 1
              </h2>
            </div>
 ...
 <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-12 font-serif">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="w-10 h-[2px] bg-[#9c3545] mb-2"></div>
            <h2 className="text-3xl sm:text-4xl italic text-[#9c3545] font-serif tracking-wider font-light">
              Type 2
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex border border-zinc-300 bg-white shadow-sm">
              ...
              <div className="p-4 flex flex-col justify-center text-xs sm:text-sm">
                ...
                <p className="text-zinc-700"><span className="font-semibold text-zinc-900">Toll Free:</span> 1224 2234 LAW</p>
            ...
            <div className="flex border border-zinc-300 bg-white shadow-sm">
              ...
              <div className="p-4 flex flex-col justify-center text-xs sm:text-sm">
                ...
                <p className="text-[#9c3545] cursor-pointer hover:underline">support@livecon.com</p>
            ...
            <div className="flex border border-zinc-300 bg-white shadow-sm">
              ...
              <div className="p-4 flex flex-col justify-center text-xs sm:text-sm">
                ...
                <p className="text-zinc-600 leading-snug">625 @ David Blake Road,</p>
