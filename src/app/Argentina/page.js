...
//             >
// Explore the distinctive wines of Argentina.
// Discover La Espera, Carpe Diem, Gran Reserva, and Kurt Heinlein wines from Mendoza,
// featuring expressive Malbec, Cabernet Sauvignon, Syrah, Cabernet Franc, Chardonnay,
// and the aromatic Torrontés.
//             </motion.p>
//           </div>
...
//     Argentina Wine Collection
//     </h2>

//  <p className="mx-auto mt-4 max-w-xl font-old-standard text-sm leading-6 text-white">
// Discover a curated collection of Argentine wines from Mendoza,
// featuring expressive Malbec, elegant Cabernet Sauvignon, aromatic Torrontés,
// and distinctive blends crafted with French and American oak.
// </p>
//   </div>
...
// Laurentia • Argentina Wine Collection
// </p>
...
import { ArrowUpRight, ArrowLeft, ShoppingBag, MapPin } from "lucide-react";

const regions = [
  {
    name: "La Espera, Mendoza",
    slug: "la-espera-mendoza",
  },
];

export default function ArgentinaRegionsPage() {
  return (
      ...
      <section className="px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pb-16 lg:pt-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl font-old-standard text-base leading-7 text-[#6D625B] sm:text-lg">
            Discover the distinctive wines of Argentina, shaped by high-altitude
            vineyards, mountain landscapes, and the celebrated terroirs of Mendoza.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          {/* <div className="mb-10 text-center">
            ...
            <p className="mt-3 font-old-standard text-sm text-[#6D625B]">
              {regions.length} unique wine region
            </p>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {regions.map((region, index) => (
              ...
              <Link
                key={region.slug}
                href={`/regions/argentina/${region.slug}`}
                className="
                  group
                  relative
                  min-h-[225px]
          ...
          >
            ...
            <p className="font-old-standard text-sm text-[#6D625B]">
              Personally selected from across Argentina
            </p>
